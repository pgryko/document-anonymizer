...
class PathSecurityError(ValidationError):
    ...
    def __init__(self, field_name: str, pattern: str, path: str) -> None:
...
class PathResolutionError(ValidationError):
    ...
    def __init__(self, field_name: str, error: str) -> None:
...
class PathNotAllowedError(ValidationError):
    ...
    def __init__(self, field_name: str, path: str, allowed_bases: list) -> None:
        super().__init__(
...
class UnsupportedFileExtensionError(ValidationError):
    ...
    def __init__(self, field_name: str, extension: str) -> None:
...
class InvalidStyleError(ValueError):
    ...
    def __init__(self, valid_styles: set) -> None:
...
class ImageDimensionsTooLargeError(ValidationError):
    ...
    def __init__(self, width: int, height: int, limit: int) -> None:
...
class ImageDimensionsTooSmallError(ValidationError):
    ...
    def __init__(self, width: int, height: int, min_size: int) -> None:
...
class UNetChannelMismatchError(ValidationError):
    ...
    def __init__(self, actual: int, expected: int = 9) -> None:
...
class InvalidLossDetectedError(TrainingError):
    ...
    def __init__(self, total_loss: float, recon_loss: float, kl_loss: float) -> None:
        super().__init__(
...
class DownloadFailedAfterRetriesError(InferenceError):
    ...
    def __init__(self, max_retries: int, error: str) -> None:
...
class UnsupportedChecksumTypeError(ValidationError):
    ...
    def __init__(self, checksum_type: str) -> None:
...
class ImagePadError(ImageProcessingError):
    ...
    def __init__(self, message: str = "Failed to pad image") -> None:
        super().__init__(message)
...
class ChannelConversionError(ImageProcessingError):
    ...
    def __init__(self, message: str = "Failed to convert image channels") -> None:
        super().__init__(message)
...
class EpochTrainingError(TrainingError):
    ...
    def __init__(self, epoch: int, error: str) -> None:
...
class SchedulerInitializationError(ConfigurationError):
    ...
    def __init__(self, scheduler_type: str) -> None:
...
class ConfidenceOutOfRangeError(ValidationError):
    ...
    def __init__(self, confidence: float, min_conf: float, max_conf: float) -> None:
...
class OrientationOutOfRangeError(ValidationError):
    ...
    def __init__(self, orientation: float, min_degrees: float, max_degrees: float) -> None:
        super().__init__(
